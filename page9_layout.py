...
page_9_layout = html.Div([
    ...
    dbc.Row([dbc.Col(html.Div(dcc.Link('Go to Previous Page ', href='/page-8'),), style={'textAlign':'center'}, width=2),
            dbc.Col(html.Div([
                 html.Hr(),
                    ...
                    html.Hr(),
                dcc.Dropdown(
                                    id='dropdown-8', multi=False, className="four columns",
                    ...
                    html.Div(dcc.Graph(id='graph-15')),
                    html.Div(dcc.Graph(id='graph-16')),], className="row"),
                    html.Br(),
                    dcc.Link('Go back to home', href='/'),          
                    html.Br(),
            ]), width=8),
            dbc.Col(html.Div(dcc.Link('Go to Next Page ', href='/page-10'),), style={'textAlign':'center'}, width=2),
        ]),
    ])