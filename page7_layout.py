...
page_7_layout = html.Div([
    ...
    dbc.Row([
            dbc.Col(html.Div(dcc.Link('Go to Previous Page ', href='/page-6'),), style={'textAlign':'center'}, width=2),
            dbc.Col(html.Div([html.Hr(),
                    ...
                    html.Hr(),dcc.Dropdown(
                                    id='dropdown-6', multi=False, className="four columns",
                    ...
                    html.Div(dcc.Graph(id='graph-12')),], className="row"),
                    html.Br(),
                    dcc.Link('Go back to home', href='/'),          
                    html.Br(),
            ]), width=8),
            dbc.Col(html.Div(dcc.Link('Go to Next Page ', href='/page-8'),), style={'textAlign':'center'}, width=2),
        ]),
    ])